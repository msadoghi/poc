...
void Stats::IncClientCall() { client_call_++; }

void Stats::IncClientRequest() { num_client_req_++; }

void Stats::IncPropose() { num_propose_++; }

void Stats::IncPrepare() { num_prepare_++; }

void Stats::IncCommit() { num_commit_++; }

void Stats::IncPendingExecute() { pending_execute_++; }

void Stats::IncExecute() { execute_++; }

void Stats::IncExecuteDone() { execute_done_++; }

void Stats::BroadCastMsg() { broad_cast_msg_++; }
...
void Stats::IncTotalRequest(uint32_t num) { total_request_ += num; }

void Stats::ServerCall() { server_call_++; }

void Stats::ServerProcess() { server_process_++; }
